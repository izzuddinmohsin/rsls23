...
$query = "SELECT * FROM users JOIN registration ON users.id = registration.id_login WHERE users.username = '$username'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">Participant Account</h1>
<div class="text-right">
    <a href="participant_management/updateParticipant.php" class="btn btn-primary mb-3">Update Participant Details</a>
</div>
...
<div class="card card-outline card-primary">
    <div class=" card card-outline  ">
            <div class="container-fluid">
                ...
                <h1 class="h5 mb-4 text-gray-800">Participant Account</h1>
