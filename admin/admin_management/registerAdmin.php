...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO users (username, password, email, access_level) 
    ...
    if ($conn->query($query) === TRUE) {
        ...
        $Id = $user['id'];
        $query = "INSERT INTO admin (admin_name, admin_phone, admin_address, id_login) 
        VALUES ('$admin_name', '$admin_phone', '$admin_address', '$Id')";
        if ($conn->query($query) === TRUE) {   
...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">Admin Account Registration</h1>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control form-control-user" name="admin_phone"id="admin_phone" >
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="access_level" id="access_level" class="form-control" value="admin" placeholder="admin" disabled>
                    </div>
                    <div class="form-group">
                        <label for="Address">Address</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" id="admin_address" name="admin_address" rows="3"></textarea>
                    </div>
                    <div class="card-footer">
                        <div class="col-md-12">
                            <div class="row">
                              <button class="btn btn-sm btn-primary mr-2" id="submit" type="submit">Save</button>
